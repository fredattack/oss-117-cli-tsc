...
const fetchQuotes = (params) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.get('https://oss-117-quotes-api.herokuapp.com/quotes', { params });
...
(0, yargs_1.default)((0, helpers_1.hideBin)(process.argv))
    ...
    handler: (argv) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (argv.character)
            params.character = argv.character;
        if (argv.keyword)
            params.keyword = argv.keyword;
